...
export class LobbyAPI {
  ...
  // POST /games/{game_name}/create : create a new room with authentication
  ...
  // POST /games/{game_name}/{room_id}/join : join a specific room, pass in their player id and name
  ...
  // POST /games/{game_name}/{room_id}/leave : leave a room (given that you had already joined it previously), pass in their player id authentication token
  ...
  // GET /games/{game_name}/{room_id} and then return the players field of the game
